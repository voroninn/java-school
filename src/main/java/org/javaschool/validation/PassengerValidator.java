...
public class PassengerValidator implements Validator {
    ...
    public void validate(Object o, Errors errors) {
        ...
        if (passengerService.getPassengerByPassportNumber(passenger.getPassportNumber()) != null &&
                passengerService.getPassengerByPassportNumber(passenger.getPassportNumber()).getId()
                        != passenger.getId()) {
            errors.rejectValue("passportNumber", "Duplicate.passengerForm.passportNumber");
        }
    }
}